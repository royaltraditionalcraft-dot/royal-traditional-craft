  ...
  return (
    <footer className="bg-primary-dark text-gray-300 py-12 mt-12 font-body">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-2xl font-heading text-accent-gold mb-4">WoodCraft India</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>Email: support@woodcraftindia.com</li>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-gray-700 text-sm text-center">
        &copy; {new Date().getFullYear()} WoodCraft India. All rights reserved.
      </div>
    </footer>
  );
};
