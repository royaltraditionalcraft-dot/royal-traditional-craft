  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          "isolate z-50 transition-all duration-200",
          className
        )}
        {...props}
      >
        <NavigationMenuPrimitive.Popup className="relative overflow-hidden rounded-lg bg-white text-foreground shadow-lg ring-1 ring-black/5 outline-none">
